...
export const ARES_NFT_ADDRESS = "0x7dc3c11bc2ce4a65b2e6782639a4449bccb41b30" //"0xb81A3659Ca24b3312F285A649870220a68AC5287" // goerli testnet
export const WHITELIST_ALLOWANCE = 3
export const PUBLIC_ALLOWANCE = 2
export const WHITELIST_NFT_PRICE = new BigNumber("860000000000000") // 0.00086
export const PRESALE_NFT_PRICE = new BigNumber("1500000000000000") // 0.0015
export const PUBLIC_SALE_NFT_PRICE = new BigNumber("2000000000000000") // 0.002
